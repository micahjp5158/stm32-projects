...
#define GPIOx_PUPDR0_0     BIT0    // Port 0 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR0_1     BIT1    // Port 0 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR1_0     BIT2    // Port 1 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR1_1     BIT3    // Port 1 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR2_0     BIT4    // Port 2 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR2_1     BIT5    // Port 2 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR3_0     BIT6    // Port 3 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR3_1     BIT7    // Port 3 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR4_0     BIT8    // Port 4 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR4_1     BIT9    // Port 4 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR5_0     BIT10   // Port 5 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR5_1     BIT11   // Port 5 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR6_0     BIT12   // Port 6 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR6_1     BIT13   // Port 6 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR7_0     BIT14   // Port 7 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR7_1     BIT15   // Port 7 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR8_0     BIT16   // Port 8 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR8_1     BIT17   // Port 8 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR9_0     BIT18   // Port 9 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR9_1     BIT19   // Port 9 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR10_0    BIT20   // Port 10 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR10_1    BIT21   // Port 10 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR11_0    BIT22   // Port 11 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR11_1    BIT23   // Port 11 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR12_0    BIT24   // Port 12 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR12_1    BIT25   // Port 12 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR13_0    BIT26   // Port 13 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR13_1    BIT27   // Port 13 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR14_0    BIT28   // Port 14 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR14_1    BIT29   // Port 14 pull-up or pull-down configuration [1]
#define GPIOx_PUPDR15_0    BIT30   // Port 15 pull-up or pull-down configuration [0]
#define GPIOx_PUPDR15_1    BIT31   // Port 15 pull-up or pull-down configuration [1]
...
#define GPIOx_AFRH8_0   BIT0    // Alternate function selection for port 8 [0]
#define GPIOx_AFRH8_1   BIT1    // Alternate function selection for port 8 [1]
#define GPIOx_AFRH8_2   BIT2    // Alternate function selection for port 8 [2]
#define GPIOx_AFRH8_3   BIT3    // Alternate function selection for port 8 [3]
#define GPIOx_AFRH9_0   BIT4    // Alternate function selection for port 9 [0]
#define GPIOx_AFRH9_1   BIT5    // Alternate function selection for port 9 [1]
#define GPIOx_AFRH9_2   BIT6    // Alternate function selection for port 9 [2]
#define GPIOx_AFRH9_3   BIT7    // Alternate function selection for port 9 [3]
#define GPIOx_AFRH10_0  BIT8    // Alternate function selection for port 10 [0]
#define GPIOx_AFRH10_1  BIT9    // Alternate function selection for port 10 [1]
#define GPIOx_AFRH10_2  BIT10   // Alternate function selection for port 10 [2]
#define GPIOx_AFRH10_3  BIT11   // Alternate function selection for port 10 [3]
#define GPIOx_AFRH11_0  BIT12   // Alternate function selection for port 11 [0]
#define GPIOx_AFRH11_1  BIT13   // Alternate function selection for port 11 [1]
#define GPIOx_AFRH11_2  BIT14   // Alternate function selection for port 11 [2]
#define GPIOx_AFRH11_3  BIT15   // Alternate function selection for port 11 [3]
#define GPIOx_AFRH12_0  BIT16   // Alternate function selection for port 12 [0]
#define GPIOx_AFRH12_1  BIT17   // Alternate function selection for port 12 [1]
#define GPIOx_AFRH12_2  BIT18   // Alternate function selection for port 12 [2]
#define GPIOx_AFRH12_3  BIT19   // Alternate function selection for port 12 [3]
#define GPIOx_AFRH13_0  BIT20   // Alternate function selection for port 13 [0]
#define GPIOx_AFRH13_1  BIT21   // Alternate function selection for port 13 [1]
#define GPIOx_AFRH13_2  BIT22   // Alternate function selection for port 13 [2]
#define GPIOx_AFRH13_3  BIT23   // Alternate function selection for port 13 [3]
#define GPIOx_AFRH14_0  BIT24   // Alternate function selection for port 14 [0]
#define GPIOx_AFRH14_1  BIT25   // Alternate function selection for port 14 [1]
#define GPIOx_AFRH14_2  BIT26   // Alternate function selection for port 14 [2]
#define GPIOx_AFRH14_3  BIT27   // Alternate function selection for port 14 [3]
#define GPIOx_AFRH15_0  BIT28   // Alternate function selection for port 15 [0]
#define GPIOx_AFRH15_1  BIT29   // Alternate function selection for port 15 [1]
#define GPIOx_AFRH15_2  BIT30   // Alternate function selection for port 15 [2]
#define GPIOx_AFRH15_3  BIT31   // Alternate function selection for port 15 [3]
