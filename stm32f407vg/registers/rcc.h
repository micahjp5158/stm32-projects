...
#define RCC_PLL_CFGR_PLLN1  BIT7    // Main PLL (PLL) multiplication factor for VCO [1]
#define RCC_PLL_CFGR_PLLN2  BIT8    // Main PLL (PLL) multiplication factor for VCO [2]
#define RCC_PLL_CFGR_PLLN3  BIT9    // Main PLL (PLL) multiplication factor for VCO [3]
#define RCC_PLL_CFGR_PLLN4  BIT10   // Main PLL (PLL) multiplication factor for VCO [4]
#define RCC_PLL_CFGR_PLLN5  BIT11   // Main PLL (PLL) multiplication factor for VCO [5]
#define RCC_PLL_CFGR_PLLN6  BIT12   // Main PLL (PLL) multiplication factor for VCO [6]
#define RCC_PLL_CFGR_PLLN7  BIT13   // Main PLL (PLL) multiplication factor for VCO [7]
#define RCC_PLL_CFGR_PLLN8  BIT14   // Main PLL (PLL) multiplication factor for VCO [8]
...
#define RCC_CFGR_MCO2_PRE_2 BIT29   // MCO2 prescaler [2]
